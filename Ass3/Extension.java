...
public class Extension extends GraphicsProgram {
	...
	/*
	 * increases the velocity of the ball if a brick is removed
	 */
	...
	private void printLosingMessage() {
		addLabelInCenter("You've Lost");
	}
	
	/*
	 * prints a text in the center of the window
	 */
	private void addLabelInCenter(String str) {
	 ...
	 * bounces the ball off if it's a paddle
	 */
	private void checkCollidingObject() {
		...
		if (collidingObject == paddle && lowerYCoordinateOfBall == HEIGHT - PADDLE_Y_OFFSET - PADDLE_HEIGHT) {
			...
			vy = -vy;
		} else if (collidingObject != null && collidingObject != paddle && lowerYCoordinateOfBall <= HEIGHT - PADDLE_Y_OFFSET - PADDLE_HEIGHT + 1) {
			bounceClip.play();
